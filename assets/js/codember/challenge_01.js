function contarRepeticiones(cadena) {
    ...
    for (var i = 0; i < palabras.length; i++) {
      ...
      // Si la palabra ya está en el objeto de frecuencia, incrementamos su contador
      if (frecuencia[palabra]) {
        frecuencia[palabra]++;
      } else {
        // Si la palabra no está en el objeto de frecuencia, la inicializamos en 1
    ...
    // Recorremos las propiedades del objeto de frecuencia
    for (var palabra in frecuencia) {
      if (frecuencia.hasOwnProperty(palabra)) {
        // Agregamos la palabra y su frecuencia a la cadena de salida
